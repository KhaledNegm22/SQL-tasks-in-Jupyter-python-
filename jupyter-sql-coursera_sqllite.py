...
get_ipython().run_line_magic('sql', "select Customer from SPACEXTABLE where (Landing_Outcome ='Success (drone ship)' and PAYLOAD_MASS__KG_ between 4000 and 6000)")
...
get_ipython().run_line_magic('sql', "select count(*) from SPACEXTABLE where Mission_Outcome like 'Success%'")


# In[31]:


get_ipython().run_line_magic('sql', "select count(*) from SPACEXTABLE where Mission_Outcome like 'Failure%'")
...
get_ipython().run_line_magic('sql', "select substr(Date, 6,2) as month ,Booster_Version ,Launch_Site from SPACEXTABLE where (substr(Date,0,5)='2015'and Landing_Outcome ='Failure (drone ship)')")
...
get_ipython().run_line_magic('sql', "SELECT Landing_Outcome, count(*) AS outcome_count from SPACEXTABLE where Date between '2010-06-04' and '2017-03-20' GROUP BY Landing_Outcome ORDER BY outcome_count DESC")
